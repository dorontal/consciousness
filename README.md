...
2. Every "thing" in the universe is causally "connected" to a set of
   other "things", in the sense that every thing arises when something
   else has arisen, stays in existence while the other thing stays in
